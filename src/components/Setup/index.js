    ...
    const handleSubmit=(e)=>{
        ...
        if(!id){
            ...
            userRef.update({
                ...
                city: city,
                label: label,
                profileImage: imageUrl ? imageUrl : 'https://firebasestorage.googleapis.com/v0/b/the-app-af0f5.appspot.com/o/content%20image%2Fnoimage.png?alt=media&token=ad88512f-8cd5-4374-a8a9-310034cde6e6'
        ...
        return (
            <div id='setup'>
                <div>
                    <p>Setup Profile</p>
                    {imageUrl ? (<img src={imageUrl} alt='default profile image'/>) :
                     (<img src='https://firebasestorage.googleapis.com/v0/b/the-app-af0f5.appspot.com/o/content%20image%2Fnoimage.png?alt=media&token=ad88512f-8cd5-4374-a8a9-310034cde6e6' alt='default profile image'/>)}
                </div> 
                <input onChange={handleChange} id='image' type="file" name='profileImage'></input>
                <div>
                <TextField
                id="input"
                select
